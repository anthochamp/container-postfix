...
export POSTFIX_TLSRPT_LOG_LEVEL="${POSTFIX_TLSRPT_LOG_LEVEL:-warn}"
...
export POSTFIX_TLS_POLICY_SERVICE_HOST="${POSTFIX_TLS_POLICY_SERVICE_HOST:-}"
export POSTFIX_TLS_POLICY_SERVICE_TLS="${POSTFIX_TLS_POLICY_SERVICE_TLS:-0}"
export POSTFIX_TLS_POLICY_SERVICE_TLS_SKIP_VERIFY="${POSTFIX_TLS_POLICY_SERVICE_TLS_SKIP_VERIFY:-0}"
export POSTFIX_TLS_POLICY_SERVICE_TLS_CA_FILE="${POSTFIX_TLS_POLICY_SERVICE_TLS_CA_FILE:-}"
export POSTFIX_TLS_POLICY_SERVICE_TLS_CERT_FILE="${POSTFIX_TLS_POLICY_SERVICE_TLS_CERT_FILE:-}"
export POSTFIX_TLS_POLICY_SERVICE_TLS_CERT_KEY_FILE="${POSTFIX_TLS_POLICY_SERVICE_TLS_CERT_KEY_FILE:-}"

export POSTFIX_SENDER_CANONICAL_MAP_HOST="${POSTFIX_SENDER_CANONICAL_MAP_HOST:-}"
export POSTFIX_SENDER_CANONICAL_MAP_TABLE="${POSTFIX_SENDER_CANONICAL_MAP_TABLE:-forward}"
export POSTFIX_SENDER_CANONICAL_MAP_TLS="${POSTFIX_SENDER_CANONICAL_MAP_TLS:-0}"
export POSTFIX_SENDER_CANONICAL_MAP_TLS_SKIP_VERIFY="${POSTFIX_SENDER_CANONICAL_MAP_TLS_SKIP_VERIFY:-0}"
export POSTFIX_SENDER_CANONICAL_MAP_TLS_CA_FILE="${POSTFIX_SENDER_CANONICAL_MAP_TLS_CA_FILE:-}"
export POSTFIX_SENDER_CANONICAL_MAP_TLS_CERT_FILE="${POSTFIX_SENDER_CANONICAL_MAP_TLS_CERT_FILE:-}"
export POSTFIX_SENDER_CANONICAL_MAP_TLS_CERT_KEY_FILE="${POSTFIX_SENDER_CANONICAL_MAP_TLS_CERT_KEY_FILE:-}"

export POSTFIX_RECIPIENT_CANONICAL_MAP_HOST="${POSTFIX_RECIPIENT_CANONICAL_MAP_HOST:-}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TABLE="${POSTFIX_RECIPIENT_CANONICAL_MAP_TABLE:-reverse}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TLS="${POSTFIX_RECIPIENT_CANONICAL_MAP_TLS:-0}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_SKIP_VERIFY="${POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_SKIP_VERIFY:-0}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CA_FILE="${POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CA_FILE:-}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CERT_FILE="${POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CERT_FILE:-}"
export POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CERT_KEY_FILE="${POSTFIX_RECIPIENT_CANONICAL_MAP_TLS_CERT_KEY_FILE:-}"
...
if [ -n "$POSTFIX_SENDER_CANONICAL_MAP_HOST" ]; then
	if [ "$POSTFIX_SENDER_CANONICAL_MAP_TLS" -eq 0 ]; then
		export POSTFIX_SENDER_CANONICAL_MAP_PORT="${POSTFIX_SENDER_CANONICAL_MAP_PORT:-11380}"

		export _POSTFIX_SENDER_CANONICAL_MAP_HOST="$POSTFIX_SENDER_CANONICAL_MAP_HOST"
		export _POSTFIX_SENDER_CANONICAL_MAP_PORT="$POSTFIX_SENDER_CANONICAL_MAP_PORT"
	else
		if [ -z "${POSTFIX_SENDER_CANONICAL_MAP_PORT:-}" ]; then
			echo "$0": missing POSTFIX_SENDER_CANONICAL_MAP_PORT environment variable
			exit 1
		fi

		export _POSTFIX_SENDER_CANONICAL_MAP_HOST=127.0.0.20
		export _POSTFIX_SENDER_CANONICAL_MAP_PORT=10004
	fi
fi

if [ -n "$POSTFIX_RECIPIENT_CANONICAL_MAP_HOST" ]; then
	if [ "$POSTFIX_RECIPIENT_CANONICAL_MAP_TLS" -eq 0 ]; then
		export POSTFIX_RECIPIENT_CANONICAL_MAP_PORT="${POSTFIX_RECIPIENT_CANONICAL_MAP_PORT:-11380}"

		export _POSTFIX_RECIPIENT_CANONICAL_MAP_HOST="$POSTFIX_RECIPIENT_CANONICAL_MAP_HOST"
		export _POSTFIX_RECIPIENT_CANONICAL_MAP_PORT="$POSTFIX_RECIPIENT_CANONICAL_MAP_PORT"
	else
		if [ -z "${POSTFIX_RECIPIENT_CANONICAL_MAP_PORT:-}" ]; then
			echo "$0": missing POSTFIX_RECIPIENT_CANONICAL_MAP_PORT environment variable
			exit 1
		fi

		export _POSTFIX_RECIPIENT_CANONICAL_MAP_HOST=127.0.0.20
		export _POSTFIX_RECIPIENT_CANONICAL_MAP_PORT=10005
	fi
fi
...
if [ -n "$POSTFIX_TLS_POLICY_SERVICE_HOST" ]; then
	if [ "$POSTFIX_TLS_POLICY_SERVICE_TLS" -eq 0 ]; then
		export POSTFIX_TLS_POLICY_SERVICE_PORT="${POSTFIX_TLS_POLICY_SERVICE_PORT:-8642}"

		export _POSTFIX_TLS_POLICY_SERVICE_HOST="$POSTFIX_TLS_POLICY_SERVICE_HOST"
		export _POSTFIX_TLS_POLICY_SERVICE_PORT="$POSTFIX_TLS_POLICY_SERVICE_PORT"
	else
		if [ -z "${POSTFIX_TLS_POLICY_SERVICE_PORT:-}" ]; then
			echo "$0": missing POSTFIX_TLS_POLICY_SERVICE_PORT environment variable
			exit 1
		fi

		export _POSTFIX_TLS_POLICY_SERVICE_HOST=127.0.0.20
		export _POSTFIX_TLS_POLICY_SERVICE_PORT=10006
	fi
fi
