...
export POSTFIX_MYSQL_TABLE_DOMAINS="${POSTFIX_MYSQL_TABLE_DOMAINS:-domains}"
export POSTFIX_MYSQL_TABLE_USERS="${POSTFIX_MYSQL_TABLE_USERS:-users}"
export POSTFIX_MYSQL_TABLE_ALIASES="${POSTFIX_MYSQL_TABLE_ALIASES:-aliases}"
